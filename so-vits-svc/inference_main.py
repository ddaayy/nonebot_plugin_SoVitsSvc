...
chunks_dict = infer_tool.read_temp("src/plugins/nonebot_plugin_SoVitsSvc/so-vits-svc/inference/chunks_temp.json")
...
def main():
    ...
    infer_tool.mkdir(["src/plugins/nonebot_plugin_SoVitsSvc/so-vits-svc/raw", "src/plugins/nonebot_plugin_SoVitsSvc/so-vits-svc/results"])
    ...
    for clean_name, tran in zip(clean_names, trans):
        raw_audio_path = f"src/plugins/nonebot_plugin_SoVitsSvc/so-vits-svc/raw/{clean_name}"
        ...
        for spk in spk_list:
            ...
            if use_spk_mix:
                spk = "spk_mix"
            res_path = f'src/plugins/nonebot_plugin_SoVitsSvc/so-vits-svc/results/{clean_name}_{key}_{spk}{cluster_name}_{isdiffusion}_{f0p}.{wav_format}'
